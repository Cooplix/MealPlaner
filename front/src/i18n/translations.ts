...
export const translations: Record<Language, Record<string, unknown>> = {
  en: {
    ...
    calendar: {
      ...
      clearDay: "Clear day",
      daySummary: {
        coverage: "Coverage: {{filled}}/{{total}}",
        caloriesTotal: "Total: {{calories}} kcal",
      },
      recommendationsTitle: "Recommendations",
      recommendationsHint:
        "Based on overlap, your inventory, and variety. Skips dishes already scheduled this week.",
      recommendationsEmpty: "No suggestions — add more dishes or plan at least one day.",
      recommendations: {
        scoreBadge: "Fit: {{level}}",
        score: {
          high: "High",
          medium: "Medium",
          low: "Low",
        ...
        stockLine: "Stock {{count}}/{{total}}",
        lastUsed: "Last used: {{date}}",
        neverUsed: "Never used",
        inventoryWarning: "Couldn't load inventory: {{message}}",
      },
      add: "Add",
  ...
  uk: {
    ...
    dishes: {
      ...
      detailsClose: "Закрити",
      detailsNotes: "Рецепт",
      moreIngredients: "+{{count}} інгредієнтів",
      editor: {
        nameLabel: "Назва",
        mealLabel: "Пора дня",
    ...
    calendar: {
      ...
      daySummary: {
        coverage: "Покриття: {{filled}}/{{total}}",
        caloriesTotal: "Всього: {{calories}} ккал",
      },
      recommendationsTitle: "Рекомендації",
      recommendationsHint:
        "На основі перетину інгредієнтів, запасів і різноманіття. Уникаємо страв, вже запланованих цього тижня.",
      recommendationsEmpty: "Немає пропозицій — додай кілька страв або заплануй хоча б один день.",
      recommendations: {
        scoreBadge: "Відповідність: {{level}}",
        score: {
          high: "Висока",
          medium: "Середня",
          low: "Низька",
        ...
        stockLine: "Запаси {{count}}/{{total}}",
        lastUsed: "Останній раз: {{date}}",
        neverUsed: "Не використовувалась",
        inventoryWarning: "Не вдалося завантажити запаси: {{message}}",
      },
      add: "Додати",
  ...
  pl: {
    ...
    dishes: {
      ...
      detailsClose: "Zamknij",
      detailsNotes: "Przepis",
      moreIngredients: "+{{count}} składników",
      editor: {
        nameLabel: "Nazwa",
        mealLabel: "Pora dnia",
    ...
    calendar: {
      ...
      daySummary: {
        coverage: "Pokrycie: {{filled}}/{{total}}",
        caloriesTotal: "Razem: {{calories}} kcal",
      },
      recommendationsTitle: "Rekomendacje",
      recommendationsHint:
        "Na podstawie wspólnych składników, zapasów i różnorodności. Pomija dania już zaplanowane w tym tygodniu.",
      recommendationsEmpty: "Brak propozycji — dodaj więcej dań lub zaplanuj przynajmniej jeden dzień.",
      recommendations: {
        scoreBadge: "Dopasowanie: {{level}}",
        score: {
          high: "Wysokie",
          medium: "Średnie",
          low: "Niskie",
        ...
        stockLine: "Zapas {{count}}/{{total}}",
        lastUsed: "Ostatnio: {{date}}",
        neverUsed: "Nigdy nie użyte",
        inventoryWarning: "Nie udało się wczytać zapasów: {{message}}",
      },
      add: "Dodaj",
